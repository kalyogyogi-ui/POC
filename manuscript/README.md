...
| Appendices | `appendices/` | A–E | Planned |

## Conventions

- One file per chapter: `chapter-NN-short-title.md`
- Figures and tables referenced inline; production artwork to follow
- Case study organizations: Meridian Mutual Bank, Northfield Energy Systems, Apex Defense Technologies, GlobalSync Logistics
